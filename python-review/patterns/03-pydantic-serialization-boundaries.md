# Pydantic and Serialization Boundaries

## Problem

Agents manually serialize ORM/Pydantic objects despite existing schema models.

## Smells

Handwritten dicts in routes; repeated `.isoformat()`; duplicated schema names; `Optional` everywhere; validators doing business logic.
...
> Who owns the external shape of this data?
