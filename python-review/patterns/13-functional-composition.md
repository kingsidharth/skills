# Functional Composition vs Service Sprawl

## Problem

Agents prefer `Service`, `Manager`, `Processor`, and classes even when functions compose better.

## Smells

Stateless classes; `BaseService`; deep inheritance; giant function; tiny helpers with no boundary.
...
> Is this a class because it owns state, or because the agent wanted architecture cosplay?
