# Naming, Comments, and Docs

## Problem

Agents produce generic names, noisy comments, and unnecessary docs.

## Smells

`process_data`; `ServiceManager`; comments narrating code; README updates not requested; implementation-summary files.
...
> Does this text reduce ambiguity or merely add words?
