...
Agents confuse robustness with suppressing errors.

## Smells

Broad exceptions returning `None`; retry without idempotency; fallback hiding missing data; logs warning but marks complete.
...
> What happens if this line succeeds and the next line fails?
