...
Agents prefer Service classes and repository-pattern cosplay even when functions are clearer.

## Smells

Stateless `Service`; service imports `HTTPException`; repository commits; service returns API response dicts; weak `BaseService`.
...
> Is this layer adding meaning or only vocabulary?
