# Shims, v2, and Backward Compatibility Layers

## Problem

Agents avoid decisive refactors by creating `v2`, `legacy`, `compat`, or shim layers.

## Smells

`service_v2.py`; `legacy_adapter.py`; two implementations side-by-side; old behavior kept “just in case”.
...
> Is this shim required by a real external constraint, or fear disguised as safety?
